...
public class UpdateBean implements Parcelable {
    ...
    private boolean showCheckInfo = false;  // 是否显示检查版本结果

    public boolean isShowCheckInfo() {
        return showCheckInfo;
    }

    public void setShowCheckInfo(boolean showCheckInfo) {
        this.showCheckInfo = showCheckInfo;
    }
