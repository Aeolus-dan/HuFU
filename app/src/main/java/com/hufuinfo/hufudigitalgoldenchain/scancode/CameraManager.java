...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		/*	int width = screenResolution.x * 3 / 4;
			...
			Log.w(TAG,"width = " + width + "screenResolution.x = " + screenResolution.x +"ye add");
			...
			Log.w(TAG, "heigt = " + height + "screenResolution.y" + screenResolution.y +"ye add");*/
			int width, height;
			if(screenResolution.x < screenResolution.y) {
				width = height = screenResolution.x;
			} else {
				width = height = screenResolution.y;
			}
