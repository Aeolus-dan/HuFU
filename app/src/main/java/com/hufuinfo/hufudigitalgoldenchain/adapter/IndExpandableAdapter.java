...
public class IndExpandableAdapter extends BaseExpandableListAdapter {

    private static final String TAG = "IndExpandableAdapter";
    ...
    public IndExpandableAdapter(String[] groupData, String[][] childData) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            groupViewHolder.tvTitle = convertView.findViewById(R.id.label_group_indicator);
